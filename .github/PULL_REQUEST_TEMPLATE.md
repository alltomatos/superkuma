<!--
⚠️ NO AI SLOP!!!
If you just feed the issue to a code agent, generate code + an LLM description, and open this PR without reviewing or testing anything yourself, this PR will be closed.
See CLAUDE.md for this project's review policy: every change must be understood and manually tested by a human before it is submitted.
-->
