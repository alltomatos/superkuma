...
const sslKey = process.env.SUPERKUMA_SSL_KEY || process.env.SSL_KEY || undefined;
const sslCert = process.env.SUPERKUMA_SSL_CERT || process.env.SSL_CERT || undefined;
...
let hostname = process.env.SUPERKUMA_HOST;
...
const port = parseInt(process.env.SUPERKUMA_PORT || process.env.PORT || 3001);
